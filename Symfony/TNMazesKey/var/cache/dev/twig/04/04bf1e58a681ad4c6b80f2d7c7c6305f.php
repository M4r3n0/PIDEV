...
class __TwigTemplate_f00e1fecbba5bb85cdd893cd0e1a588f extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t\t<a href=\"";
        // line 138
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_restaurant_edit", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["restaurant"]) || array_key_exists("restaurant", $context) ? $context["restaurant"] : (function () { throw new RuntimeError('Variable "restaurant" does not exist.', 138, $this->source); })()), "id", [], "any", false, false, false, 138)]), "html", null, true);
        echo "\">edit</a>
\t\t\t\t\t\t\t\t\t\t</button>
\t\t\t\t\t\t\t\t\t\t";
        // line 140
...
\t\t\t\t\t\t\t\t";
    ...
    {
        return array (  370 => 140,  365 => 138,  359 => 135,  351 => 130,  344 => 126,  336 => 121,  329 => 117,  322 => 113,  315 => 109,  308 => 105,  301 => 101,  292 => 95,  288 => 93,  278 => 92,  142 => 143,  140 => 92,  111 => 66,  44 => 1,);
    }
...
", "restaurant/show.html.twig", "C:\\xampp\\htdocs\\TNMazesKey\\templates\\restaurant\\show.html.twig");
    }
}
