...
/* avis/new.html.twig */
class __TwigTemplate_af4f1c8ea84ea0f9e26949d1d0a077f4 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t<h2>Avez vous aimé ce Restaurant ?</h2>

\t\t\t\t\t</div>

\t\t\t\t\t<div class=\"row\">
\t\t\t\t\t\t<div class=\"col-md-6\">
\t\t\t\t\t\t\t<img src=\"/assets/img/speakers/star_rating__w676__h416__.png\" alt=\"Speaker 1\" class=\"img-fluid\">
\t\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t\t";
    ...
    {
        return array (  225 => 90,  219 => 87,  214 => 84,  204 => 83,  130 => 93,  128 => 83,  44 => 1,);
    }
...
\t\t\t\t\t\t\t\t\t\t<a href=\"{{ path('app_restaurant_indexClient') }}\">Retour</a>
\t\t\t\t\t\t\t\t\t</center>
\t\t\t\t\t\t\t\t{% endblock %}
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t</div>
...
", "avis/new.html.twig", "C:\\xampp\\htdocs\\TNMazesKey\\templates\\avis\\new.html.twig");
    }
}
